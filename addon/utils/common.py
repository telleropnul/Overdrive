...
def update_panel_category(self, context):
    category = prefs().od_panel_category
    ui.main_panel.OverdrivePanel.bl_category = category
    ui.main_panel.OverdrivePanel.bl_region_type = 'UI' if category else 'HEADER'
    bpy.utils.unregister_class(ui.main_panel.OverdrivePanel)
    bpy.utils.register_class(ui.main_panel.OverdrivePanel)